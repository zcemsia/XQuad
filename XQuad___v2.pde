// xQuad - Project Titan : Ismail Ahmad v2.0
...
void liftCalculations(){
  ...
  if (thetaZO < 1.5708 && thetaZO > 0){
  cLX = 2 * PI * thetaZO;
  liftX = -(0.5 * cLX * density * velocityXI * velocityXI * (surfaceA*cos(thetaZO)));
  }
  else{
  cLX = 2* PI * thetaZO;
  liftX = (0.5 * cLX * density * velocityXI * velocityXI * (surfaceA*cos(thetaZO)));
  ...
  if (thetaXO < 1.5708 && thetaXO > 0){
  cLZ = 2* PI * thetaXO;
  liftZ = -(0.5 * cLZ * density * velocityZI * velocityZI * (surfaceA*cos(thetaXO)));
  }
  else{
  cLZ = 2* PI * thetaXO;
  liftZ = (0.5 * cLZ * density * velocityZI * velocityZI * (surfaceA*cos(thetaXO)));
